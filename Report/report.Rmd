...
Marathon running is a popular sport that attracts millions of participants worldwide. The completion time of a marathon is influenced by various factors, including weather conditions. A 42-km marathon footrace is among the most physiologically demanding endurance events, with competitive runners typically maintaining a pace corresponding to 70-90% of their maximal aerobic capacity for more than 2 hours. At maximal mechanical efficiency, more than 80% of the energy required is transferred as heat to the body core, producing approximately 1400 kcal/hour that must be dissipated to prevent dangerous rises in body temperature.

While numerous studies have documented performance degradation in hot environments, research has largely focused on elite male runners, leaving the implications for slower competitors and women runners largely speculative. Additionally, there has been limited research examining performance when tasks elicit only modest elevations in core body temperature (<38.5°C). In this report, we analyze the impact of different weather conditions on marathon performance across the lifespan in both men and women using data from five major marathons: Boston, NYC, Chicago, Twin Cities, and Grandmas. We aim to examine effects of increasing age on marathon performance in men and women and the impact of environmental conditions on marathon performance, and whether the impact differs across age and gender. Additionally, we want to find out which factor has the most significant impact on marathon performance.
...
The Marathon Data contains information about the top completion record percentage grouped by age and sex of runners in five major marathons: Boston, NYC, Chicago, Twin Cities, and Grandmas. The dataset includes the following columns:
...
ggsave("../Plots/rh_effect.png", plot = rh_effect, width = 15, height = 8, dpi = 300)
rh_effect
...
ggsave("../Plots/wind_effect.png", plot = wind_effect, width = 15, height = 8, dpi = 300)
wind_effect
...
ggsave("../Plots/sr_effect.png", plot = sr_effect, width = 15, height = 8, dpi = 300)
sr_effect
...
In this report, we analyzed the effect of inner factors (age, sex) and outer factors (weather variables) on marathon performance. Through comprehensive analysis of data from five major marathons, we identified several key findings regarding both physiological and environmental impacts on marathon completion times.

Our analysis revealed that while male and female runners have objectively different race performance with males generally running faster, weather conditions affect both genders similarly, suggesting the performance gap is primarily due to physiological differences rather than differential weather sensitivity. This finding aligns with Ely et al. (2007), who found similar patterns of weather-related performance decrements between male and female elite runners. However, weather conditions do have significantly different effects across age groups. The WBGT variable demonstrated the strongest impact on completion percentage, with a 0.6903 percent increase plus a -0.0034 age adjustment for each unit increase in WBGT. This supports findings from Ely et al. (2010) showing that aerobic performance is degraded in hot environments even with modest hyperthermia.

The relative humidity (RH) and solar radiation (SR) showed comparatively smaller impacts on performance, though their effects were still statistically significant. Interestingly, wind speed demonstrated a unique pattern - while it had a relatively minor direct effect on performance, it showed the strongest interaction with age among all weather variables, suggesting older runners may be particularly sensitive to wind conditions. This age-dependent response to weather conditions likely reflects the reduced thermoregulatory capacity and cardiovascular adaptability documented in older adults.

The progressive impact of increasing WBGT on performance across all age groups supports the concept of a "prescriptive zone" for temperature regulation during exercise, as described by Ely et al. (2007). When environmental conditions push runners outside this zone, performance necessarily declines as the body struggles to maintain thermal homeostasis. This is particularly evident in our finding that the performance impact of adverse weather conditions increases with both age and completion time, suggesting that slower runners face compounded challenges from prolonged exposure to challenging weather conditions.

A limitation of our analysis is that the dataset only captures weather variables without accounting for other important factors such as training status, nutrition, and general health status. Additionally, the smaller sample sizes in the youngest (10-19) and oldest (80-99) age groups may affect the reliability of our findings for these populations. Future research would benefit from incorporating these additional variables and ensuring more balanced representation across age groups.

These findings have important practical implications for runners, race organizers, and medical personnel. They suggest that race organizers should consider developing age-specific guidelines for weather-based race modifications, rather than applying uniform standards across all participants. Runners, particularly older athletes or those expecting longer completion times, should adjust their race strategies and performance expectations based on weather conditions, with special attention to WBGT forecasts. Future research could focus on developing more precise models for predicting individual performance decrements based on both personal factors (age, sex, fitness level) and environmental conditions.
