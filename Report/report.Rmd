...
Similarly, we would hope that participants' gender is balanced in the dataset. From the plot below, we can tell the Female:Male portion is roughly equal to 1 in all of the races, which is a good feature for our analysis.

```{r sex_distribution_race, fig.width = 10, fig.height = 8}
...
```{r cr_distribution_plot, fig.width = 8, fig.height = 5}
